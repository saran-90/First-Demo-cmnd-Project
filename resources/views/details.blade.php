...
<head>
    <meta charset="UTF-8">
    <title>Projects Single || crystalo || Responsive HTML 5 Template</title>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="video-holder-box">
                            <div class="img-holder">
                                <img src="images/projects/project-single/video-gallery-1.jpg" alt="Awesome Image">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="single-project-image-gallery">
                            <img src="images/projects/project-single/image-gallery-1.jpg" alt="Awesome Image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="single-similar-project">
                            <div class="img-holder">
                                <img src="images/projects/project-single/similar-pro-1.jpg" alt="Awesome Image">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="single-similar-project">
                            <div class="img-holder">
                                <img src="images/projects/project-single/similar-pro-2.jpg" alt="Awesome Image">
                            </div>
                            <div class="title-holder">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="single-similar-project">
                            <div class="img-holder">
                                <img src="images/projects/project-single/similar-pro-3.jpg" alt="Awesome Image">
                            </div>
                            <div class="title-holder">
                                <span>Traditional</span>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                        <div class="single-similar-project">
                            <div class="img-holder">
                                <img src="images/projects/project-single/similar-pro-4.jpg" alt="Awesome Image">
                            </div>
                            <div class="title-holder">
                                <span>Retreat</span>
